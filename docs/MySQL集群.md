...
2023-11-09T05:51:34.353527Z 1 [Note] A temporary password is generated for root@localhost: !Ikhhjl_+5bB
```
...
192.168.19.165
###################################
[root@MYSQL-MASTER ~]# hostnamectl set-hostname 'MYSQL-CLUSTER01'
[root@MYSQL-SLAVE ~]# hostnamectl set-hostname 'MYSQL-CLUSTER02'
...
Nov 10 14:21:12 mysql-cluster01 systemd[1]: Stopped LSB: start and stop MySQL.
Nov 10 14:21:12 mysql-cluster01 systemd[1]: Starting LSB: start and stop MySQL...
Nov 10 14:21:14 mysql-cluster01 mysql[13178]: Starting MySQL.. SUCCESS!
Nov 10 14:21:14 mysql-cluster01 systemd[1]: Started LSB: start and stop MySQL.
```
...
```shell
[root@mysql-cluster01 ~]# mysql -uroot -p'test1234'
...
```shell
[root@mysql-cluster02 ~]# systemctl restart mysql
[root@mysql-cluster02 ~]# systemctl status mysql
● mysql.service - LSB: start and stop MySQL
   Loaded: loaded (/etc/rc.d/init.d/mysql; bad; vendor preset: disabled)
...
Nov 10 15:01:08 mysql-cluster02 systemd[1]: Stopped LSB: start and stop MySQL.
Nov 10 15:01:08 mysql-cluster02 systemd[1]: Starting LSB: start and stop MySQL...
Nov 10 15:01:09 mysql-cluster02 mysql[10932]: Starting MySQL. SUCCESS!
Nov 10 15:01:09 mysql-cluster02 systemd[1]: Started LSB: start and stop MySQL.
```
...
[root@mysql-cluster02 ~]# mysql -uroot -p'test1234'
